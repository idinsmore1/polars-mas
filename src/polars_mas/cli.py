...
def create_parser() -> argparse.ArgumentParser:
    ...
    param_group = parser.add_argument_group("Association Parameters", "Options for specifying association parameters")
    ...
    sex_specific_group.add_argument(
        "--male-only",
        action="store_true",
        help="Include only male samples in the analysis."
    )
    sex_specific_group.add_argument(
        "--female-only",
        action="store_true",
        help="Include only female samples in the analysis."
    )
    return parser
